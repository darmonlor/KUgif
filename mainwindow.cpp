...
void MainWindow::on_actionOpen_triggered()
{
    ...
    QMessageBox::warning(this,"file", QString("My magic number is %1. That's all!").arg(animationSource->framesCount()));
    ui->horizontalSlider->setMaximum(animationSource->framesCount()-2);
    animationSource->Draw(ui->label);

    ui->timeLabel->setText(QString("%1 : %2").arg(QString::number(ui->horizontalSlider->value()+1),QString::number(animationSource->framesCount()-1)));
...
void MainWindow::on_horizontalSlider_valueChanged(int value)
{
    ...
    ui->timeLabel->setText(QString("%1 : %2").arg(QString::number(value+1),QString::number(animationSource->framesCount()-1)));
}

void MainWindow::on_horizontalSlider_2_valueChanged(int value)
{
    animationSource->Draw(ui->label_2,value);
    ui->timeLabel_2->setText(QString("%1 : %2").arg(QString::number(value+1),QString::number(animationSource->framesCount()-1)));
}
...
void MainWindow::on_frameRemoveButton_clicked()
{
    ...
    ui->timeLabel_2->setText(QString("%1 : %2").arg(QString::number(ui->horizontalSlider_2->value()),QString::number(animationSource->framesCount()-1)));
